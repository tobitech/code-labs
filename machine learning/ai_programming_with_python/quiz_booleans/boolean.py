...
# more dense than that of Rio de Janeiro?
...
# and False otherwise
print(f"San Francisco Population Density: {san_francisco_pop_density}")
print(f"Rio De Janeiro Population Density: {rio_de_janeiro_pop_density}")
