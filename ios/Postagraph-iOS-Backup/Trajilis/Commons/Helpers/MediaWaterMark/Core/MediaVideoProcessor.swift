...
extension MediaProcessor {
    func processVideoWithElements(item: MediaWatermarkItem, completion: @escaping ProcessCompletionHandler) {
    ...
    // MARK: - private
    private func processAndAddElements(item: MediaWatermarkItem, layer: CALayer) {
