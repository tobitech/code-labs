...
class MyTabBar: UITabBar {
    ...
    private func addShape() {
        ...
        // the below 4 lines are for shadow above the bar. you can skip them if you don't want a shadow.
    ...
    func createPath() -> CGPath {
        ...
        path.addCurve(to: CGPoint(x: (centerWidth + height * 2), y: 0), controlPoint1: CGPoint(x: (centerWidth + 35), y: height), controlPoint2: CGPoint(x: centerWidth + 35, y: 0))
